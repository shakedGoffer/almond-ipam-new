        ...
        <div className="flex flex-col flex-1 min-w-min gap-6">
            ...
            <Card >
                ...
                <div className="flex flex-row gap-4 justify-around">
                    <ul>
                        <li>Subnet Address: {subnetAddress}/{subnet.subnet_cidr}</li>
                    ...
                    <ul>
                        ...
                        <li>Total Addresses: {Object.keys(subnet.allocated_ips).length}</li>
                    </ul>
                </div>
            </Card>
            <div className="flex flex-col gap-4">
                <SearchBar />
                <Table data={formatAddressesData(subnet.allocated_ips)} columns={columns} />
            </div>
